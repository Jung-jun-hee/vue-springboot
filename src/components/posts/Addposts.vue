...
<!--            <input type="text" class="form-control" id="id" required v-model="post.post_id" name="id">-->
        </div>

<!--        <div class="form-group">-->
<!--            <label for="name">name</label>-->
<!--            <input type="text" class="form-control" id="name" required v-model="post.board_name" name="name">-->
<!--        </div>-->
<!--        <div class="form-group">-->
<!--            <label for="header">name</label>-->
<!--            <input type="text" class="form-control" id="header" required v-model="post.header" name="header">-->
<!--        </div>-->
        <div class="form-group" >
